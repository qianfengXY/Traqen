...
co-creator 已于 2026-09-15 授权以已验收的 [F003 功能全景设计 V2.0](../design/F003-traceability-graph/README.zh-CN.md) 替换之前的设计主图。该文档引用同一份已验收 HTML/PNG，保留八组功能、五档分流、回流路径、版本校验值及验收追溯；V1.0 降为历史记录。
