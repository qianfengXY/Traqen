...
The reference adapters currently discover endpoint-centered Feature/implementation candidates and deterministic write relations. Domain rules, state machines, permissions and TestSpec design remain protocol-supported output types but require future specialized adapters and human review.
