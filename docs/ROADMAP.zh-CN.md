...
|---|---|---|---|---|---|---|
| F001 | P0 | 工作空间与源码真相 | spec | CodeX | co-creator 已确认的[Source Truth 方案设计](design/F001-workspace-source-truth/README.md) | [F001](features/F001-legacy-system-understanding.zh-CN.md) |
| F002 | P0 | 确定性证据与 API 结构 | spec | TBD | operator 已确认的重构 | [F002](features/F002-feature-api-traceability.zh-CN.md) |
| F003 | P1 | Agent 候选与审阅后的业务功能树 | spec | TBD | operator 已确认的重构 | [F003](design/F003-traceability-graph/README.md) |
