...
| F003 | [Functional Panorama V2.0](F003-traceability-graph/README.md) and [Feature entry](../features/F003-traceability-graph.md) | The eight functional groups and five routing outcomes are published. Access interfaces, field contracts, and quantitative acceptance values remain open. |
...
Historical documents live in [the archive](../archive/README.md). Each archived document declares `superseded_by`; archive material is not part of the active navigation.
