...
| F003 | [功能设计 V2.0（2026-09-17 发布版）](F003-traceability-graph/README.md)与[Feature 入口](../features/F003-traceability-graph.zh-CN.md) | 八组功能逐项说明、五档分流与主活动；沿用已验收 V2.0 原图。访问接口、字段合同和量化验收值仍待确定，UX 探索不属于已确认设计。 |
