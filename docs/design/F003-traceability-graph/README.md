...
UX 效果图直接嵌在[第 10 节](#10-ux-效果图与交互说明待讨论)，远程阅读不需要打开本地服务。旧 UX v0.2 页面仅保留迁移导航，不再独立维护设计正文；[旧 UX v0.1](../../../feature-discussions/2026-09-09-F003-traceability-graph-design/ux-v0.1.zh-CN.md) 仅供历史参考。
