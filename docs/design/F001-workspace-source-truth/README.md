...
> 本轮设计仅维护中文；[英文旧版](../../../feature-discussions/2026-08-30-F001-workspace-source-truth-design/README.md)保留作历史参考，不与本轮修订视为等价。设计已确认；2026-09-06 已获完整编码实现授权，当前进入实现阶段，尚未完成运行验收。见[实施计划](../../../feature-specs/2026-09-06-f001-source-truth-implementation.md)。
...
> 目录统一：依 co-creator 2026-09-19 授权（`0001789795568668-000196-bd4d7d48`），本页与配套图稿由原讨论目录迁入 `docs/design/`，正文功能合同不变。PR #44 的图文修订尚未合入，不在本次目录迁移中提前采纳。
