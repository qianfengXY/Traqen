...
for (const control of ["scope-switcher", "theme-switcher", "agent-child-2", "conflict-retry", "lifecycle-dialog", "mcp-paused", "f003-fixture-only", "product-toolbar", "recent-viewed", "workspace-settings-nav", "draft-saved", "fixture-tools"]) {
