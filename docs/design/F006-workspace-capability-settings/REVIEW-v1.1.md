...
| S06 | 两种恢复有不同后果；M2/M3不误确认；冲突期间零额外自动写；恢复后清除阻断态并返回可编辑团队页 |
...
- 冻结图稿源：`ux-v1.0/assets/prototype.html`（SHA-256 `7c676330c9b31d6b1da9cee2d69eec4bf4875ea65f22f0b9ed0cc825852a391e`）、`render.mjs`、[25 张场景图与清单](ux-v1.0/assets/SHA256SUMS)、[浏览器验证记录](ux-v1.0/assets/verification.json)。当前记录来自隔离 HeadlessChrome 153：25 张图、14 条检查、0 个页面错误；清单共 26 条（原型源加 25 张图）。检查记录包含 1440×900 母版、1920×1080 的 1.2×/96px 留白、2560×1440 的 1.6×/128px 留白、1400×860/1280×800 的 1×下限，以及滚轮/End纵向可达、归一化几何、真实点击、版本往返与焦点检查。
