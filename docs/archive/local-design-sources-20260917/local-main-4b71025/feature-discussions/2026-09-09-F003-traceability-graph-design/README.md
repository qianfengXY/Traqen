...
> **Frontend UX exploration:** [Open the UX v0.1 illustrated draft (Chinese)](ux-v0.1.zh-CN.md). All four primary screens are embedded for remote document reading, with no localhost or preview server required. The UX remains exploratory and replaceable; the V2.0 functional baseline below is unchanged.
