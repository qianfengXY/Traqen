...
- Local Workspace analysis lets a user name a Workspace, choose a source directory without uploading it, scan supported files in page memory, browse all discovered capabilities in a Feature tree, and inspect each candidate's five-part trace and explicit governance gaps.
