...
export function F006SettingsCenter(props: Props) {
  ...
  useEffect(() => {
    if (!edited || edited === savedEdited || !recoveryReady || working || autosaveInFlight.current) return;
  ...
  }, [autosaveAttempt, edited, onAutoSave, recoveryReady, savedEdited, working]);
  ...
  if (props.scope === "global") return <section className="f006-settings-center">
    ...
    <div className="f006-global-shell">
      ...
      <div className="f006-global-content">
        ...
        {(globalPage === "skills" || globalPage === "mcp") && <GlobalCapabilities {...props} working={props.working || (globalPage === "skills" && !skillVerified)} kind={globalPage === "skills" ? "SKILL" : "MCP"} name={capabilityName} setName={setCapabilityName} description={capabilityDescription} setDescription={setCapabilityDescription} onAdd={() => void addGlobalCapability(globalPage === "skills" ? "SKILL" : "MCP")} onLifecycle={(target) => void requestLifecycle(target)} />}
      </div>
    </div>
