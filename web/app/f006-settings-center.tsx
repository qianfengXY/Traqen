...
function AgentSettings(props: Props & { selected: { id: string; title: string; model: string; skills: string[]; mcps: string[] } | null; selectedAgentId: string; setSelectedAgentId: (value: string) => void; agentDrawerOpen: boolean; setAgentDrawerOpen: (open: boolean) => void; availableModels: GlobalModelProfile[]; capabilities: EffectiveCapability[]; onModelChange: (model: string) => void; onToggleGrant: (kind: "SKILL" | "MCP", name: string) => void; onAddChild: () => void; onRemoveChild: (id: string) => void }) {
