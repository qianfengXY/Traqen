...
function WorkspaceCapabilities(props: Props & { localKind: "SKILL" | "MCP"; setLocalKind: (value: "SKILL" | "MCP") => void; localName: string; setLocalName: (value: string) => void; onToggle: (entry: EffectiveCapability) => void; onAddLocal: () => void }) {
  const groups = [
