...
export type FrozenVersion = { id: string; publishedAt: string; counts: Counts; identity: { inventoryId: string; gapSetId: string }; components: (Counts & { id: string; sourceId: string; kind: string; scope: SourceInput["scope"]; nativeIdentity: SourceSummary["nativeIdentity"]; sourceUrl?: string | null })[]; latestReceipt: Receipt | null; currentAdmission: "NOT_CHECKED" };
